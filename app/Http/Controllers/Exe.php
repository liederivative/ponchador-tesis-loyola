...
function addProf($CC){
    ...
    $opts = array('PL','PM','PMM','PJ','PV','PS','PDD','PDN','PDV');
    $vals = array();
    foreach($opts as $o){
        if(isset($_POST[$o])){
           $vals[$o] = ($_POST[$o]?1:0); 
    ...
    // avoid SQL Injection
    $left_vals = array('PNombre'=>$PNombre,'PApellido'=>$PApellido,
                       'PCedula'=>$PCedula,'PCelular'=>$PCelular,
                       'PMatricula'=>$PMatricula,'PDireccion'=>$PDireccion,'PTelefono'=>$PTelefono,'Estatus'=>0);
...
//    echo "<br><br>";
    ...
    $left_vals = array('PNombre'=>$PNombre,'PApellido'=>$PApellido,
                       'PCedula'=>$PCedula,'PCelular'=>$PCelular,
                       'PMatricula'=>$PMatricula,'PDireccion'=>$PDireccion,'PTelefono'=>$PTelefono,'Data'=>$Data);
    $vals = array_merge($vals,$left_vals);
